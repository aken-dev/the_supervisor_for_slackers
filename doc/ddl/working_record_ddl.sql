...
CREATE TABLE `working_record` (
  ...
  `stage` int(11) NOT NULL COMMENT '現在の作業番号',
  ...
  `standby_status` int(11) DEFAULT 0 COMMENT '待機状態（0=準備完了，1=バッチ処理中，2=バッチ再計算処理待ち，3=バッチ異常終了）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='作業記録';